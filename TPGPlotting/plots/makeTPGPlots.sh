...
#html_dir='/eos/user/user/c/ccecal/scratch0/www/TPGAnalysis/EETriggerTests'
...
.L ${work_dir}/DrawTPGplots.C+
DrawTPGplots("newhistoTPG_${run_num}${appendix}.root",${run_number_int},kTRUE,"png","${html_dir}/${run_num}${appendix}",0)
.q
!
...
.L ${work_dir}/DrawTPGplots.C+
DrawTPGplots("newhistoTPG_Ecal_${run_num}${appendix}.root",${run_number_int},kTRUE,"png","${html_dir}/${run_num}${appendix}",1)
.q
!
...
<A HREF=${http_dir}/${run_num}$appendix/TPdist_306456_oldped.png> <img height="200" src="${http_dir}/${run_num}$appendix/thumb_TPdist_306456_oldped.jpg"> </A>
<A HREF=${http_dir}/${run_num}$appendix/TPint_306456_oldped.png> <img height="200" src="${http_dir}/${run_num}$appendix/thumb_TPint_306456_oldped.jpg"> </A>
<A HREF=${http_dir}/${run_num}$appendix/spikeratint_306456_oldped.png> <img height="200" src="${http_dir}/${run_num}$appendix/thumb_spikeratint_306456_oldped.jpg"> </A>
<A HREF=${http_dir}/${run_num}$appendix/spikerat_306456_oldped.png> <img height="200" src="${http_dir}/${run_num}$appendix/thumb_spikerat_306456_oldped.jpg"> </A>
...
<A HREF=${http_dir}/${run_num}$appendix/TPGAnalysis_occupancyTPEmulEEPlus_when_no_real_NZ_TP_0_${run_number_int}.png> <img height="200" src="${http_dir}/${run_num}$appendix/thumb_TPGAnalysis_occupancyTPEmulEEPlus_when_no_real_NZ_TP_0_${run_number_int}.jpg"> </A>
...
<A HREF=${http_dir}/${run_num}$appendix/TPGAnalysis_occupancyTPEmulEEPlus_when_no_real_NZ_TP_1_${run_number_int}.png> <img height="200" src="${http_dir}/${run_num}$appendix/thumb_TPGAnalysis_occupancyTPEmulEEPlus_when_no_real_NZ_TP_1_${run_number_int}.jpg"> </A>
...
#rm newhistoTPG_${run_num}${appendix}.root
#rm  newhistoTPG_Ecal_${run_num}${appendix}.root 
