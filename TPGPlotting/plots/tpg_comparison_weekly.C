//to run in root: .x tpg_comparison_weekly.C+("/store/caf/user/taroni/TPG/", "newhistoTPG_267996_eg12.root", "newhistoTPG_268006_eg12.root")
#include <iostream>
#include <string> 
#include <sstream> 
#include "TFile.h"
...
void tpg_comparison_weekly(string eosdir, string oldfile, string newfile){
  ...
  name1.str(""); 
  name2.str(""); 
  std::size_t found = eosdir.find("store/");
  if (found!=std::string::npos){
    name1 << "root://eoscms//eos/cms"<< eosdir << oldfile; 
    name2 << "root://eoscms//eos/cms"<< eosdir << newfile;
  }else{
    name1 << eosdir << oldfile; 
    name2 << eosdir << newfile; 
  }
 
  TFile * f2 = TFile::Open(name2.str().c_str(), "READ");
  TFile  * f1= TFile::Open(name1.str().c_str(), "READ");
  ...
  TLegend leg1(0.65,0.65,0.85,0.85);
  ...
  c1->SaveAs("validationplots/tpspect_eep_2015vs2013.png");
  ...
  c1->SaveAs("validationplots/tpspect_eem_2015vs2013.png");
  ...
  c1->SaveAs("validationplots/tpspect_eb_2015vs2013.png");
  ...
  c1->SaveAs("validationplots/tpspectrat_eep_2015vs2013.png");
  ...
  c1->SaveAs("validationplots/tpspectrat_eem_2015vs2013.png");
  ...
  c1->SaveAs("validationplots/tpspectrat_eb_2015vs2013.png");
  ...
  c1->SaveAs("validationplots/tpspect_accum_eb_2015vs2013.png");
  ...
  c1->SaveAs("validationplots/tpspect_accum_eep_2015vs2013.png");
  ...
  c1->SaveAs("validationplots/tpspect_accum_eem_2015vs2013.png");
  ...
  leg2.Draw();
  c1->SaveAs("validationplots/tpspect_accumrat_ee_2015vs2013.png");
  ...
  c1->SaveAs("validationplots/tpspect_accumrat_eb_2015vs2013.png");
  ...
  c1->SaveAs("validationplots/eep_occ_old_2015vs2013.png");

  eep_occup_2->Draw("colz");
  t1.DrawLatex(0.5,0.92,"Emulated TP Occupancy, EE+ - NEW");
  c1->SaveAs("validationplots/eep_occ_new_2015vs2013.png");

  eem_occup_1->Draw("colz");
  t1.DrawLatex(0.5,0.92,"Emulated TP Occupancy, EE- - OLD");
  c1->SaveAs("validationplots/eem_occ_old_2015vs2013.png");

  eem_occup_2->Draw("colz");
  t1.DrawLatex(0.5,0.92,"Emulated TP Occupancy, EE- - NEW");
  c1->SaveAs("validationplots/eem_occ_new_2015vs2013.png");
  ...
  c1->SaveAs("validationplots/eep_occ_newoverold_2015vs2013.png");


  eemrat2d->Draw("colz");
 
  t1.DrawLatex(0.5,0.92,"Emulated TP Occupancy, EE- RATIO: NEW/OLD");
  c1->SaveAs("validationplots/eem_occ_newoverold_2015vs2013.png");
  ...
  c1->SaveAs("validationplots/eep_occ_vs_eta_2015vs2013.png");
  ...
  t1.DrawLatex(0.5,0.92,"Emulated TP Occupancy vs #eta: EE-");
  c1->SaveAs("validationplots/eem_occ_vs_eta_2015vs2013.png");
  ...
  c1->SaveAs("validationplots/occ_ratio_vs_eta_2015vs2013.png");
  ...
  c1->SaveAs("validationplots/eb_occ_ratio_2d_2015vs2013.png");
  ...
  c1->SaveAs("validationplots/eb_occ_vs_eta_2015vs2013.png");
  ...
  c1->SaveAs("validationplots/eb_occ_ratio_vs_eta_2015vs2013.png");
  ...
  c5.SaveAs("validationplots/eb_occ_ratio_1d_2015vs2013.png");
  ...
  c5.SaveAs("validationplots/eep_occ_ratio_1d_2015vs2013.png");
  ...
  c5.SaveAs("validationplots/eep_occ_ratio_1d_etabin1_2015vs2013.png");
  ...
  c5.SaveAs("validationplots/eep_occ_ratio_1d_etabin2_2015vs2013.png");
  ...
  c5.SaveAs("validationplots/eep_occ_ratio_1d_etabin3_2015vs2013.png");
  ...
  c5.SaveAs("validationplots/eep_occ_ratio_1d_etabin4_2015vs2013.png");
  ...
  c5.SaveAs("validationplots/eep_occ_ratio_1d_etabin5_2015vs2013.png");
  ...
  eem_occrat_1d->Draw();
  t1.DrawLatex(0.5,0.92,"EE-");
  c5.SaveAs("validationplots/eem_occ_ratio_1d_2015vs2013.png");
  ...
  t1.DrawLatex(0.5,0.92,"EE-, 1.5<|#eta|<1.8");
  c5.SaveAs("validationplots/eem_occ_ratio_1d_etabin1_2015vs2013.png");
  ...
  t1.DrawLatex(0.5,0.92,"EE-, 1.8<|#eta|<2.1");
  c5.SaveAs("validationplots/eem_occ_ratio_1d_etabin2_2015vs2013.png");
  ...
  t1.DrawLatex(0.5,0.92,"EE-, 2.1<|#eta|<2.4");
  c5.SaveAs("validationplots/eem_occ_ratio_1d_etabin3_2015vs2013.png");
  ...
  t1.DrawLatex(0.5,0.92,"EE-, 2.4<|#eta|<2.7");
  c5.SaveAs("validationplots/eem_occ_ratio_1d_etabin4_2015vs2013.png");
  ...
  t1.DrawLatex(0.5,0.92,"EE-, |#eta|>2.7");
  c5.SaveAs("validationplots/eem_occ_ratio_1d_etabin5_2015vs2013.png");
