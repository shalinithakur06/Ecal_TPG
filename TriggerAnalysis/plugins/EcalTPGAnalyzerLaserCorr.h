#ifndef EcalTPGAnalyzerLaserCorr_h
#define EcalTPGAnalyzerLaserCorr_h
// -*- C++ -*-
//
...
class EcalTPGAnalyzerLaserCorr : public edm::EDAnalyzer {
public:
  explicit EcalTPGAnalyzerLaserCorr(const edm::ParameterSet&);
  ~EcalTPGAnalyzerLaserCorr();  
