...
config.General.requestName = 'SingleNeutrinoGun_GEN-SIM-DIGI-RAW_1-2000_5Sept19'
config.General.transferOutputs = True
config.General.transferLogs = False

config.section_("JobType")
config.JobType.pluginName = 'Analysis'
config.JobType.psetName = 'ecalTPGAnalysis_MC_1-2000_2019.py' 
config.JobType.allowUndistributedCMSSW = True

config.JobType.maxMemoryMB = 4000
#config.JobType.maxJobRuntimeMin = 600
config.JobType.outputFiles = ['ECALTPGtree.root']
config.Data.userInputFiles = open('file_SingleNeutrino_1-2000.txt').readlines()
