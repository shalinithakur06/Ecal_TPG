...
// Thu Oct 31 08:49:40 2019 by ROOT version 6.18/02
// from TTree EcalTPGAnalysis/EcalTPGAnalysis
// found on file: ZeroBias_run306456.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           activeTriggers[34];   //[nbOfActiveTriggers]
   UInt_t          nbOfActiveTechTriggers;
   Int_t           activeTechTriggers[1];   //[nbOfActiveTechTriggers]
   Int_t           activeTriggersBX[160];
   Int_t           nbOfTowers;
   Int_t           ieta[1319];   //[nbOfTowers]
   Int_t           iphi[1319];   //[nbOfTowers]
   Int_t           nbOfXtals[1319];   //[nbOfTowers]
   Int_t           rawTPData[1319];   //[nbOfTowers]
   Int_t           rawTPEmul1[1319];   //[nbOfTowers]
   Int_t           rawTPEmul2[1319];   //[nbOfTowers]
   Int_t           rawTPEmul3[1319];   //[nbOfTowers]
   Int_t           rawTPEmul4[1319];   //[nbOfTowers]
   Int_t           rawTPEmul5[1319];   //[nbOfTowers]
   Int_t           crystNb[1319];   //[nbOfTowers]
   Float_t         eRec[1319];   //[nbOfTowers]
   Int_t           ttFlag[1319];   //[nbOfTowers]
   Int_t           sevlv[1319];   //[nbOfTowers]
   Int_t           spike[1319];   //[nbOfTowers]
   Int_t           rawTPEmulsFGVB1[1319];   //[nbOfTowers]
   Int_t           rawTPEmulsFGVB2[1319];   //[nbOfTowers]
   Int_t           rawTPEmulsFGVB3[1319];   //[nbOfTowers]
   Int_t           rawTPEmulsFGVB4[1319];   //[nbOfTowers]
   Int_t           rawTPEmulsFGVB5[1319];   //[nbOfTowers]
   Int_t           rawTPEmulttFlag1[1319];   //[nbOfTowers]
   Int_t           rawTPEmulttFlag2[1319];   //[nbOfTowers]
   Int_t           rawTPEmulttFlag3[1319];   //[nbOfTowers]
   Int_t           rawTPEmulttFlag4[1319];   //[nbOfTowers]
   Int_t           rawTPEmulttFlag5[1319];   //[nbOfTowers]
   Int_t           nTT_1ADC;
   Int_t           nTT_2ADC;
   Int_t           nTT_3ADC;
   Int_t           nTT_4ADC;
   ...
   Int_t           L1IsoIeta[2];   //[nbOfL1IsoCands]
   Int_t           L1IsoIphi[2];   //[nbOfL1IsoCands]
   Int_t           L1IsoRank[2];   //[nbOfL1IsoCands]
   UInt_t          nbOfL1NonisoCands;
   Int_t           L1NonisoIeta[12];   //[nbOfL1NonisoCands]
   Int_t           L1NonisoIphi[12];   //[nbOfL1NonisoCands]
   Int_t           L1NonisoRank[12];   //[nbOfL1NonisoCands]
   UInt_t          nMaskedRCT;
   ...
   Int_t           L1preIsoIeta[2];   //[nbOfL1preIsoCands]
   Int_t           L1preIsoIphi[2];   //[nbOfL1preIsoCands]
   Int_t           L1preIsoRank[2];   //[nbOfL1preIsoCands]
   UInt_t          nbOfL1preNonisoCands;
   Int_t           L1preNonisoIeta[21];   //[nbOfL1preNonisoCands]
   Int_t           L1preNonisoIphi[21];   //[nbOfL1preNonisoCands]
   Int_t           L1preNonisoRank[21];   //[nbOfL1preNonisoCands]
   UInt_t          nbOfL1postIsoCands;
   Int_t           L1postIsoIeta[2];   //[nbOfL1postIsoCands]
   Int_t           L1postIsoIphi[2];   //[nbOfL1postIsoCands]
   Int_t           L1postIsoRank[2];   //[nbOfL1postIsoCands]
   UInt_t          nbOfL1postNonisoCands;
   Int_t           L1postNonisoIeta[21];   //[nbOfL1postNonisoCands]
   Int_t           L1postNonisoIphi[21];   //[nbOfL1postNonisoCands]
   Int_t           L1postNonisoRank[21];   //[nbOfL1postNonisoCands]
   Int_t           trig_tower_adc[1319];   //[nbOfTowers]
   Int_t           trig_tower_sFGVB[1319];   //[nbOfTowers]
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("ZeroBias_run306456.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("ZeroBias_run306456.root");
      }
